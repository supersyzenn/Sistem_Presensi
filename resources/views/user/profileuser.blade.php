        ...
        <div class="p-4">
            ...
            <div class="flex items-center mb-4 relative">
                <div class="w-24 h-24 bg-teal-500 rounded-lg relative flex justify-center items-center overflow-hidden">
                    <img src="{{ $userDetail && $userDetail->foto ? asset('img/' . $userDetail->foto) : asset('img/default.jpg') }}"
            ...
            <div class="space-y-2">
                <div>
                    ...
                    <p class="font-semibold text-gray-800">{{ $userDetail ? $userDetail->jenis_kelamin : '-' }}</p>
                </div>
                <div>
                    <p class="text-gray-500">Jabatan</p>
                    <p class="font-semibold text-gray-800">{{ $userDetail ? $userDetail->jabatan : '-' }}</p>
                </div>
            </div>
        </div>
    </div>
